#!/usr/bin/env python3
# adapted from graphiler/python/graphiler/utils/bench.py
# get the latest version from https://github.com/K-Wu/graphiler_experimental/blob/main/python/graphiler/utils/bench.py
import time
import torch
import numpy as np
import pandas as pd
